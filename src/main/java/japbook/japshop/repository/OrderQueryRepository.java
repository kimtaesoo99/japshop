...
public class OrderQueryRepository {
    ...
    private Map<Long, List<OrderItemQueryDto>> findOrderItemMap(List<Long> orderIds) {
        List<OrderItemQueryDto> orderItems = em.createQuery("select new japbook.japshop.repository.OrderItemQueryDto(oi.order.id, i.name,oi.orderPrice,oi.count) " +
    ...
    private List<OrderItemQueryDto> findOrderItems(Long orderId) {
        return em.createQuery("select new japbook.japshop.repository.OrderItemQueryDto(oi.order.id, i.name,oi.orderPrice,oi.count) " +
